...
function ClassificationModal({ isOpen, onClose, type }) {
  ...
  const dataClassificationContent = (
    <div>
      <ul className="list-disc list-inside">
        ...
        <li><strong>CONFIDENTIAL (CLOUD-ELIGIBLE)</strong> - CONFIDENTIAL data that ONLY causes damage to an Agency with no damage to national interest.</li>
        <li><strong>CONFIDENTIAL</strong> - Cause some damage to national interests, or serious damage to an Agency.</li>
  ...
  const sensitivityClassificationContent = (
    <div>
      ...
      <ul className="list-disc list-inside">
        <li><strong>SENSITIVE LOW</strong> - Negligible or no physical, financial, or emotional damage to the individual, including personal information that is generally available or is reasonably expected to be generally available;</li>
      ...
      <ul className="list-disc list-inside">
        <li><strong>SENSITIVE LOW</strong> - Negligible or no impact to an entity's processes or operations, including entity information that is generally available or is reasonably expected to be generally available;</li>
